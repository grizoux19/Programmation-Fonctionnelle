...
object solver {
  ...
  def generateBoardCombinations(size: Int, rowHints: List[Row],filledmatrix: List[List[Int]]): Board = {
    ...
    println("combinsaions : \n ")
    println(rowPossibilities)
  ...
  val colHints: List[Row] = List(List(1,2,1), List(2,2,1), List(2,2,2,1), List(4,1,2), List(5,2), List(1,2,1,2), List(2,1,2,1), List(5,1), List(1,6,1), List(2,1,2))
  val rowHints : List[Row]= List(List(3,1,2), List(3,2,1), List(1,2,1), List(9), List(2,2,2),  List(1,1,2), List(10), List(1,4),List(3),List(1,7))
  //val colHints: List[Row] = List(List(1,5,1,1), List(2,1,1,4,3), List(1,1,3,6), List(10), List(1,2,1,1,2), List(1,3,5), List(10),  List(1,2,2,5), List(13,1),List(3,4,2,1),List(5,8),List(3,1,7,1),List(1,1,1,9),List(2,4,5),List(2,5,1,1))
  //val rowHints : List[Row]= List(List(2,6), List(2,7,2), List(1,1,5,1), List(3,3,1), List(1,10), List(7,2,1), List(1,2,10), List(4,9), List(1,4,1,3,1),List(4,4,3,1),List(8,5),List(2,1,7),List(5,8),List(5,1,1,2),List(3,2,4))
  ...
  //print(start(rowHints,colHints,matrix))
  }
}